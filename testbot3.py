...
class RobotControl(object):
    ...
    def camON(self):
    	print('Camera ON')
        self.cam_stream_proc = subprocess.Popen(['ffmpeg', '-s', '320x240', '-f', 'video4linux2', '-i', '/dev/video0', '-f', 'mpeg1video', '-b:v', '800k', '-r', '30', 'http://192.168.1.128:' + self.cam_stream_port + '/123/320/240/'])
...
socketIO.emit('botonline', {'id': '89757', 'msg':'bot is online'});
